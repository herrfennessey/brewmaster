...
func TestIntegration(t *testing.T) {
	...
	t.Run("parse_bean_returns_valid_profile", func(t *testing.T) {
	...
	t.Run("generate_parameters_returns_valid_brew_params", func(t *testing.T) {
		// First parse a bean profile to use as input.
